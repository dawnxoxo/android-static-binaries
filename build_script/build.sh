...
build_bin() {
  ...
  case $bin in
    ...
    "quiche") ver="0.18.0"; url="https://github.com/cloudflare/quiche";;
    ...
    "strace") ver="v6.5"; url="https://github.com/strace/strace";;
    ...
    "zlib") ver="v1.3"; url="https://github.com/madler/zlib";;
